...
/**
 * help_all - Displays all possible builtin shellcustom commands.
 */
void help_all(void)
{
	char *msg = "shellcustom\nThese shell commands are defined internally.\n";
...
/**
 * help_alias - Displays information on the shellcustom builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the shellcustom builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the shellcustom builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the shellcustom builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible shellcustom builtin commands.\n";
