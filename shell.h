...
/* Main Helpers */
ssize_t _findline(char **lineptr, size_t *n, FILE *stream);
void *_realloc1(void *ptr, unsigned int old_size, unsigned int new_size);
char **_strtok1(char *line, char *delim);
...
char *find_args(char *line, int *exe_ret);
...
int shellcustom_alias(char **args, char __attribute__((__unused__)) **front);
